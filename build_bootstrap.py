...
Output: dist/Lord's Macro - Anime Expeditions Bootstrapper.exe
"""
import subprocess
import sys
import os
...
EXE_NAME = "Lords Macro - Anime Expeditions Bootstrapper"  # see build_pyinstaller.py's EXE_NAME comment
